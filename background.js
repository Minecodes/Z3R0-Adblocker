...
const filter = [
	...
	"*:\/\/*.codr.toppr.com/*",
	"*:\/\/*.wizklub.com/*",
	"*:\/\/www.gstatic.com/external_hosted/autotrack/autotrack.js",
	"*:\/\/www.google-analytics.com/analytics.js",
	"*:\/\/www.googletagmanager.com/gtm.js?*",
	"*:\/\/tools.google.com/service/update2/dlpageping?*",
	"*:\/\/www.gstatic.com/external_hosted/autotrack/autotrack.js",
	"*:\/\/www.google-analytics.com/analytics.js",
	"*:\/\/www.googletagmanager.com/gtm.js?*",
	"*:\/\/tools.google.com/service/update2/dlpageping?*",
...
chrome.webRequest.onBeforeRequest.addListener(
    function(details) {
		chrome.browserAction.setBadgeText({ "text": count.toString() });
		console.log(`[DEBUG] ${details.initiator} -> ${details.url}`);
		count += 1;
		return { cancel: true }
